		...
		if(($('.input-rm').val().length) === 11) 
		{
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data === false) 
					{
						$this.parent().next().html("<i class='icon-remove'></i> Nomor Rekam Medis tidak ditemukan.");
					
						$(".output-FirstName").text(data);
					...
					else
					{
                        ...
                        //for (var i = 0; i < data.length; i++) { //for each user in the json response
                            $(".output-FirstName").text(data[0].FirstName);
                $(".output-DateOfBirth").text(data[0].DateOfBirth);
                if(data[0].sex == 'M') sex = "Laki-laki"; else if(data[0].sex == 'F') sex = "Perempuan"; else sex = "null"
				$(".output-sex").text(sex);
                       // } // for
