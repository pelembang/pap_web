...
$modulhapus->setFetchMode(PDO::FETCH_ASSOC);
	...
	$aColumns = array("'aksi' aksi","id","nama","jabatan_id","urut" );	
	$bColumns = array("aksi","id","nama","jabatan_id","urut" ); //columns for order
	$cColumns = array("nama","jabatan_id" ); //columns for where

	$sIndexColumn = "id";
	
	$sTable = $namadepan."pengelola";
	$sJoin = "";
	/* 
	 * Paging
	 */
