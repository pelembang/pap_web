...
<div class="box box-bordered box-color">
					...
					<table id="table_<?=$namamodul?>" class="table table-hover table-nomargin table-bordered dataTable dataTable-sorting dataTable-hidden dataTable-ajax" data-ajax-modul="<?=$namamodul?>" data-hidden="1" data-sorting="1,asc" >
