...
{
$koneksi_db->sql_query("INSERT INTO ".$namadepan."video (judul, ytid, ket, whoentri, whereentri, whenentri) VALUES ('$_POST[judul]', '$_POST[ytid]', '".addslashes(clean($_POST[ket]))."', '$_SESSION[sesi_user]', '$ipnyo', now())");
