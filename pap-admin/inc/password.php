						...
						<?php
							...
							?>
								...
								<div class="box-content nopadding">
									...
									<form action="#" method="POST" class='form-horizontal form-bordered form-validate' enctype='multipart/form-data' id="formentripassword">
										...
										<div class="control-group">
											...
											<div class="controls">
													...
													<input type="password" name="password" id="password" value="" class="span12" autocomplete="current-password" required/>
										...
										<div class="control-group">
											...
											<div class="controls">
													...
													<input type="password" name="password1" id="password1" value="" class="span12"  autocomplete="new-password" required/>
										...
										<div class="control-group">
											...
											<div class="controls">
													...
													<input type="password" name="password2" id="password2" value="" class="span12" data-rule-equalTo="#password1" title="Password tidak dengan diatas, coba lagi." autocomplete="new-password" required />
	...
	$("#formentripassword").validate({
			...
			messages: {
				...
				password1: {
					 ...
					 regex: 'Password min 10 karakter, min 1 huruf kecil, min 1 huruf besar, min 1 angka dan 1 karakter khusus'
				},
				password2: {
